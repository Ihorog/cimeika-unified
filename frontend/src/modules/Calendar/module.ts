 ...
 */
export class CalendarModule implements ModuleInterface {
  private initialized: boolean = false;
  private readonly name: string = 'calendar';
  ...
  getMetadata(): ModuleMetadata {
    return {
      name: this.name,
      version: '0.1.0',
      description: 'Time, rhythms, planning - manages schedules and temporal organization'
    };
  }
...
/**
 * Singleton instance of Calendar module
 */
