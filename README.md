...
- **3D Visualization** — інтерактивна 3D мапа екосистеми (React Three Fiber)
...
| Модуль | Маршрут | Опис | Тема | 3D Візуалізація |
|--------|---------|------|------|----------------|
| **Ci** | `/ci` | Центральне ядро, оркестрація | Day | ✅ Інтерактивна 3D мапа |
| **Казкар** | `/kazkar` | Пам'ять, історії, легенди | Night | 🔵 Orbital node |
| **Подія** | `/podija` | Події, майбутнє, сценарії | Day | 🔵 Orbital node |
| **Настрій** | `/nastrij` | Емоційні стани, контекст | Day | 🟢 Orbital node |
| **Маля** | `/malya` | Ідеї, творчість, інновації | Day | 🟣 Orbital node |
| **Галерея** | `/gallery` | Візуальний архів, медіа | Day | 🔷 Orbital node |
| **Календар** | `/calendar` | Час, ритми, планування | Day | 🟦 Orbital node |
...
- [3D Visualization](docs/CIMEIKA_3D_VISUALIZATION.md) — інтерактивна 3D мапа екосистеми
